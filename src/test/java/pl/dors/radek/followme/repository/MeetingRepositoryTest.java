...
//        List<Meeting> result = meetingRepository2.findAll();
//
...
//        List<Meeting> result = meetingRepository2.findAllByUser(users.stream().filter(p -> p.getName().equals("Radek")).findAny().get());
//
